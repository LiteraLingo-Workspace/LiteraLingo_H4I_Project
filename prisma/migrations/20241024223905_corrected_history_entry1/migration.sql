...
CREATE TABLE "UserSettings" (
    "id" SERIAL NOT NULL,
    "fontScale" INTEGER NOT NULL DEFAULT 12,
...
-- AddForeignKey
ALTER TABLE "Expression" ADD CONSTRAINT "Expression_moduleId_fkey" FOREIGN KEY ("moduleId") REFERENCES "Module"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
