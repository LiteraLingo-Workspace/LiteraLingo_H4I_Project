    ...
    if (drawerRef.current && visible) {
      ...
      children?.forEach((child: Element) => {
        ...
        if (
          ...
          htmlChild.classList.add("scrollable");
        }
      });
    }
  }, [visible]);
...
const Handle = React.forwardRef<HTMLDivElement, HandleProps>(function (
  ...
  return (
    <div
      ...
      ref={ref}
      drawer-visible={visible ? "true" : "false"}
      // @ts-ignore
      handle=""
      aria-hidden="true"
      {...rest}
    >
      ...
      <span handle-hitarea="" aria-hidden="true">
        {children}
      </span>
    </div>
  );
...
>(function ({ children, ...rest }, ref) {
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      // @ts-ignore
      overlay=""
      snap-points={isOpen && hasSnapPoints ? "true" : "false"}
      snap-points-overlay={isOpen && shouldFade ? "true" : "false"}
      {...rest}
    />
  );
});
